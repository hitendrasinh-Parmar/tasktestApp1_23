...
export const getCategoriesById = (id: string): ThunkAction<void, RootState, unknown, AnyAction> => {
...
export const { setProducts, setCategories, setLoading } = AppSlice.actions
